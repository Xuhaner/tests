...
<%
	...
	List objList=ObjectBeanService.ListMyObjectBean(uName);
...
<tr>
 <td height="26" background="skin/images/newlinebg3.gif">
  ...
  <td align=center>
    ...
    <input type='button' class="coolbg np" onClick="term_onClick();" value='终止' />
...
if(objList.size()>0){
	for(int i=0;i<objList.size();i++){
		...
		if(state==2) stateAlias = "已终止";
%>
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	<input type="hidden" name="createUser" id="nowName" value="<%=session.getAttribute("userName")%>" />
	<input type="hidden" id="oidNum" value="<%=oid%>" />
	<td><%=(i+1)%></td>
	...
	<td><div id="auName<%=oid%>"><%=ob.getTeam()%></div></td>
